...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links" id="navLinks">
                <li><a href="<?php echo URLROOT ?>/coach/dashboard"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                <li><a href="<?php echo URLROOT ?>/coach/aboutUs"><i class="fas fa-info-circle"></i> About Us</a></li>
                <li><a href="<?php echo URLROOT ?>/Coach/help"><i class="fas fa-question-circle"></i> Help</a></li>
                <li>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="profile">
            <img src="\TrackMaster\Public\img\users\Screenshot 2025-04-28 093707.png" alt="Profile Picture">
        ...
        <nav> 
            <ul>
                <li><a href="<?php echo ROOT ?>/coach/dashboard"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                <li><a href="<?php echo ROOT ?>/coach/viewprofile"><i class="fas fa-user"></i> My Profile</a></li>
                <li><a href="<?php echo ROOT ?>/coach/performancetracking"><i class="fas fa-chart-line"></i> Performance Tracking</a></li>
                <li><a href="<?php echo ROOT ?>/coach/teammanagement"><i class="fas fa-users"></i> Team Management</a></li>
                <li><a href="<?php echo ROOT ?>/coach/eventmanagement"><i class="fas fa-calendar-alt"></i> Event Management</a></li>
                <li><a href="<?php echo ROOT ?>/coach/profilemanagement"><i class="fas fa-cog"></i> Profile Management</a></li>
                <li><a href="<?php echo ROOT ?>/coach/Attendance"><i class="fas fa-clipboard-check"></i> Attendance</a></li>
            </ul>
        </nav>
