...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="profile">
            ...
            <br>
            <div style="font-size:10px;white-space: nowrap;">Guardian</div>
    </br>
            </div>
        </div>
        ...
        <nav> 
            <ul>
            <li><a href="<?php echo URLROOT ?>/guardian/dashboard"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
<li><a href="<?php echo URLROOT ?>/guardian/parentProfile"><i class="fas fa-user"></i> My Profile</a></li>
