    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="section upcoming-appointments">
                ...
                <ul>
                    ...
                    <button class="view-more-btn"
                        onclick="window.location.href='<?php echo ROOT ?>/Student/coachProfile'">View My Coach</button>
                    <button class="view-more-btn"
                        onclick="window.location.href='<?php echo ROOT ?>/Student/PlayerPerformance'">Track My
                        Performance</button>
                </ul>
            </div>
            ...
            <div class="section upcoming-appointments">
                ...
                <ul>
                    ...
                    <center><button class="view-more-btn"
                            onclick="window.location.href='<?php echo URLROOT ?>/Student/medicalStatus'">Update Medical
            ...
            <div class="section upcoming-appointments">
                ...
                <ul>
                    ...
                    <center><button class="view-more-btn"
                            onclick="window.location.href='<?php echo URLROOT ?>/Student/financialStatus'">Update
                            Financial Status</button></center>
                </ul>
            </div>
        ...
        <div class="dashboard-section achievements">
            <div class="carousel">
                <div class="carousel-inner" id="carouselAchievementsDashboard">
                    ...
                    <div class="carousel-item">
                        <div class="image-container">
                            <img src="/TrackMaster/Public/img/Student/achievements.png" alt="Achievement Image">
                        </div>
                        <div class="content-container">
                            <h3><?php echo htmlspecialchars($achievement->place); ?></h3>
                            <i>
                                <h3><?php echo htmlspecialchars($achievement->level); ?></h3>
                            </i>
                            <p><?php echo htmlspecialchars($achievement->date); ?></p>
                ...
                <button class="view-more-btn"
                    onclick="window.location.href='<?php echo URLROOT ?>/Student/studentAchievements'">View All
                    Achievements</button>
            </div>
        </div>
