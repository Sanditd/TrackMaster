...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo URLROOT ?>/student/aboutUs"><i class="fas fa-info-circle"></i> About Us</a></li>
                <li><a href="<?php echo URLROOT ?>/student/help"><i class="fas fa-question-circle"></i> Help</a></li>
                <li>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="profile">
            <img src="\TrackMaster\Public\img\users\Screenshot 2025-04-28 115247.png" alt="Profile Picture">
            <div class="profile-details">
                <div class="profile-name"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Guest'); ?></div>
                <div class="profile-role">Player</div>
            </div>
        </div>
