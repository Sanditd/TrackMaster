    ...
    <div class="Pcontainer">
        <div class="profile-container">
            <div class="profile-sidebar">
                <div class="profile-header">
                    <img src="<?php echo ROOT; ?>/Public/images/<?php echo $data['user'][0]->photo ? $data['user']->photo : 'placeholder-profile.jpg'; ?>"
                        alt="Coach Photo" class="profile-photo">
                ...
                <div class="profile-info">
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo $data['user'][0]->dob; ?></div>
                    </div>
                    <div class="info-group">
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo $data['user'][0]->gender ? $data['user']->gender : 'N/A'; ?>
                        </div>
                    </div>
                    <div class="info-group">
                        <div class="info-label">Registered Date</div>
                        <div class="info-value"><?php echo $data['user'][0]->regDate; ?></div>
                    </div>
                    <div class="info-group">
            ...
            if (isset($data['sport']) && !empty($data['sport'])) {
                foreach ($data['sport'] as $sport) {
                    if ($sport->sport_id == $data['coach']->sport_id) {
        ...
        ?>
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo $data['user'][0]->district; ?></div>
                    </div>
                    <div class="info-group">
                        <div class="info-label">Zone</div>
                        <div class="info-value">
                            <?php
            $zoneName = 'Unknown'; // default in case not found
            if (isset($data['zones']) && !empty($data['zones'])) {
                foreach ($data['zones'] as $zone) {
                    if ($zone->zoneId == $data['coach']->zone) {
                        $zoneName = $zone->zoneName;
                        break;
                    }
                }
            }
            echo htmlspecialchars($zoneName);
        ?>
                        </div>
                    </div>
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo $data['coach']->bio ? $data['coach']->bio : 'N/A'; ?></div>
                    </div>
                    <div class="actions">
                        <button class="btn btn-danger"
                            onclick="suspendUser(<?php echo $data['user'][0]->user_id; ?>)">Suspend Coach</button>
                    </div>
                </div>
            </div>
            <div class="profile-content">
                ...
                <div class="experience-item">
                    ...
                    <div class="experience-description"><?php echo $data['coach']->educational_qualifications; ?></div>
                </div>
                ...
                <!-- More sections like "Coaching Experience" and "Professional Achievements" -->
            </div>
        </div>
    </div>
