            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Cricket</td>
                        <td>
                            <button class="action-btn view-profile-btn" onclick="window.location.href='<?php echo URLROOT ?>/School/viewStudent'">
                                <i class="fas fa-id-card"></i> View Profile
                            </button>
                            <button class="action-btn view-attendance-btn">
                                <i class="fas fa-calendar-check"></i> View Attendance
                            </button>
                            <button class="action-btn view-performance-btn" onclick="window.location.href='<?php echo URLROOT ?>/Student/PlayerPerformance'">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="action-btn view-performance-btn">
                                <i class="fas fa-chart-line"></i> View Performance
                            </button>
                        </td>
                    </tr>
